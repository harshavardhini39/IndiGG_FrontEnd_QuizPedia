...
function quizResult() {
    ...
    var totalQuestion = quiz.length,
        quizSubTitle = subTitle.innerHTML,
        quizParentTitle = parentTitle.innerHTML;
...
function sendUserDetailsForEmailNotification(quizSubTitle, quizParentTitle, percentage) {
    const url = "https://Harshavardhini39.github.io/quizapp/";
    auth.onAuthStateChanged(user => {
        if (user) {
