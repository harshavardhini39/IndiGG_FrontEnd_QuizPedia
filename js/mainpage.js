...
function sendEmail(name, email, password) {
    Email.send({
            ...
            Subject: "Registration Confirmation - QuizPedia",
            Body: "<html><h1><b><font color='brown'>Hello " + name + ", </font></h1><h3>Thankyou for Registering in QuizPedia. Your User Email and Password is: </h3><br><h2>Registered email: <font color='red'> " + email + " </font><br>Password: <font color='red'> " + password + " </font></h2><br><h3> Hope you will have a great Experience with us.</h3> <h2><font color='navy'>Thanks & regards,</font><br><font color='red'>- Team QuizPedia</font><br></h2></b></html>",
        })
